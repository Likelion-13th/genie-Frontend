            ...
            <div className="footer-section">
                <div className="info-text-row">
                    ...
                    <div className="info-text-wrapper">
                        ...
                        <div className="info-text-2">지니</div>
                    </div>
                    <div className="info-text-wrapper">
                        <div className="info-text-1">사업자등록번호</div>
                        <div className="info-text-2">031-123-4567</div>
                    </div>
                    <div className="info-text-wrapper">
                ...
                <div className="info-text-row">
                    <div className="info-text-wrapper">
                        ...
                        <div className="info-text-2">010-1234-6788</div>
                    </div>
                    <div className="info-text-wrapper">
                        <div className="info-text-1">개인정보보호책임자</div>
                        <div className="info-text-2">이예진</div>
                    </div>
                    <div className="info-text-wrapper">
                        <div className="info-text-1">입금계좌</div>
                        <div className="info-text-2">0000-111-234567</div>
                    </div>
                </div>
            </div>
        </div>
